...
const post = () => {
    ...
    const post = () => {
        ...
        axios.post('http://localhost:4200/freecourse/post', { title, category, body, fileUrl, url })
            ...
            <div className="container mx-auto" >
                ...
                <div className="flex justify-center px-6 my-12">
                    ...
                    <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        <div>
                            <Image src="/post2.jpg" width={450} height={820} alt={""} className="w-full h-auto bg-gray-400 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg" />

                        </div>

                        <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">

                            <h3 className="pt-4 text-2xl text-center">Spread the knowledge!</h3>
                            <div className="px-8 pt-6 pb-8 mb-5 bg-white rounded" >
                                ...
                                <div className="mb-4 md:mr-2 md:mb-0">
                                    ...
                                    />
                                    <progress max="100" value={progressFile} className="bg-teal text-xs leading-none py-1 text-center text-white" style={{ "width": "100%" }} />
                                </div>
                                ...
                                <progress max="100" value={progressImage} className="bg-teal text-xs leading-none py-1 text-center text-white" style={{ "width": "100%" }} />
