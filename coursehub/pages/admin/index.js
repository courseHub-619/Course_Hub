...
export async function getStaticProps() {
    ...
    const student = await fetch(
        'http://localhost:4200/admin/students/all'
    )
    ...
    const post = await fetch(
        'http://localhost:4200/admin/post/all'
    )
...
const admin = ({ data, teacherList, posts, students }) => {
    ...
    return (
        <div>
            <h1 className="text-2xl font-semibold text-gray-800 leading-tight p-4"> Teachers </h1>
            ...
            <div className="flex justify-end p-8">
                <Link href={`/admin/teachers`} ><h1 className="text-l font-serif font-medium p-2">See more</h1></Link>
                <HiArrowCircleRight size={40}></HiArrowCircleRight>
            </div>

            <h1 className="text-2xl font-semibold text-gray-800 leading-tight p-4"> Students </h1>
            <div className="flex justify-between">
            ...
            <div className="flex justify-end p-8">
                <Link href={`/admin/students`} ><h1 className="text-l font-serif font-medium p-2">See more</h1></Link>
                <HiArrowCircleRight size={40}></HiArrowCircleRight>
            </div>


            <h1 className="text-2xl font-semibold text-gray-800 leading-tight p-4"> Free courses </h1>
            <div className="flex justify-around p-4">
                {
                    teacherList.map(teacher => {
                        return data.map((course) => {
                            if (course.teacher === teacher.teacher_id) {
                                if (data.indexOf(course) === render) return
            ...
            <div className="flex justify-end p-8">
                <Link href={`/admin/freeCourses`}><h1 className="text-l font-serif font-medium p-2">See more</h1></Link>
                <HiArrowCircleRight size={40}></HiArrowCircleRight>
            </div>

            <h1 className="text-2xl font-semibold text-gray-800 leading-tight p-4"> Posts </h1>
            <div className="flex justify-around p-4">
                {
                    teacherList.map(teacher => {
            ...
            <div className="flex justify-end p-8">
                <Link href={`/admin/posts`}><h1 className="text-l font-serif font-medium p-2">See more</h1></Link>
                <HiArrowCircleRight size={40}></HiArrowCircleRight>
            </div>
